...
from . import views
from .views import LessonDetailView, lessons_list, get_test, CheckAnswerView, SingleQuestion, UserQuizzAttemptsView

urlpatterns = [
    path('api/lessons/', lessons_list, name="lessons"),
    path('api/lessons/<int:lesson_id>/', LessonDetailView.as_view(), name="lesson-detail-view"),
    ...
    path('api/profile/quiz-attemts', UserQuizzAttemptsView.as_view(), name="user-quiz-attempts"),
]
